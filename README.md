...
```
npm run build
xcrun notarytool submit "./dist/trades-1.6.1-arm64.dmg" --apple-id "thibault@techinblocks.com" --password "txuv-flqw-bboi-yhqj" --team-id "BAXBQTTS3U" --wait --progress
xcrun stapler staple "dist/trades-1.6.1-arm64.dmg"
scp dist/trades-1.6.1-arm64.dmg game:~/drive/
```