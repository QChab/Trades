...
contract WalletBundlerOptimized {
    ...
    /**
     * @dev Internal assembly function to transfer ERC20 tokens
    ...
    /**
     * @dev Internal assembly function to approve ERC20 token spending
     * @param token Token contract address
    ...
    function execute(
        ...
        if (fromToken != address(0)) {
            ...
            if (balance > 0) {
                _transferToken(fromToken, owner, balance);
            }
        }
    }
    ...
    function approve(
        ...
        for (uint256 i; i < length;) {
            ...
            _approveToken(token, spenders[i], amounts[i]);
            ...
            if (spenders[i] == PERMIT2 && permit2Spender != address(0)) {
                ...
                assembly {
                    ...
                    mstore(add(ptr, 0x44), MAX_ALLOWANCE) // amount
